...
module.exports = {
	...
	// API key
	apikey: '66olUZpL0Cmk5lV4y+98Ut7gPpdq6d5K',
	...
	session: {
		...
		encryptionKey: 'ovEF3h1Ug597d1FfVfrRfMRo9cWu0FFkWYrlLPxlzM8=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'wQ+fD7w5xGaUjBC4jxTgjdrUXKwzJfZAg/JUTNKIZTw/YmDMNLaoAa2N0F2sLo+p6ozOlDo+1M8WXI3Jsu3R+Q==',
		// should be a large unguessable string
		secret: 'U0zOngYrfl41r/VHv/tJN6kC89xtr5pE',
	...
	cookieSecret: 'EfuFpR+0GlkueTf9bQGgfpqq3YaEd0RN',
	...
	authorization: {
		...
		credentials: {
			"demo-token": {
				type: "apiKey",
				key: process.env.DEMO_TOKEN || "bar"
			}
		}
	}
};
